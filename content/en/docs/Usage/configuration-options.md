...
| EnableInsightsCollector                        | `ND_ENABLEINSIGHTSCOLLECTOR`                     | Controls whether the server will run its [Insights Collector](/docs/getting-started/telemetry) feature to help improve the project.                                                                                        | `true`                                                                      |
