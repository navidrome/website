...
| DisableTelemetry                               | `ND_DISABLETELEMETRY`                            | Prevents the server from running its [Data Collection](/docs/getting-started/telemetry) feature to help improve the project.                                                                                               | `false`                                                                     |
