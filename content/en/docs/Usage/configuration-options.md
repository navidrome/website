...
| PlaylistsPath                                  | `ND_PLAYLISTSPATH`           | Where to search for and import playlists from. Can be a list of folders/globs (separated by `:` (or `;` on Windows))       | `".:**/**"` (meaning MusicDirectory and all its subfolders) |
...
| Scanner.GenreSeparator                         | `ND_SCANNER_GENRESEPARATOR`  | List of separators to split genre tags                                                                                     | `;/,`                                    |
