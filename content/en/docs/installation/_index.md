...
If you prefer a managed hosting solution in the cloud, you can use [PikaPods](/docs/installation/managed/#pikapods) or [Zenith Hosting](/docs/installation/managed/#zenith-hosting).
{{% /pageinfo %}}
